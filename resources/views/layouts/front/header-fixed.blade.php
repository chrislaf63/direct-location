    ...
    <div class="w-conversations m-auto flex">
        ...
        <div class="flex flex-col justify-center gap-5 w-full">
            ...
            <div class="flex justify-between ">
                ...
                <div>
                    <form action=""
                          class="pb-2 pr-2 bg-indigo-50 rounded-t-lg flex items-center border border-slate-300 text-slate-300 focus-within:border-slate-900 focus-within:text-slate-900 transition">
