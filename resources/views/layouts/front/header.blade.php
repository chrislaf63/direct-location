<header class="border-b-2 border-black fixed left-0 top-0 right-0 bg-white">
        ...
        <div class="flex flex-col justify-around">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('ad.create') }}">
                    <button class="bg-green-600 text-white w-[250px] flex items-center justify-center px-3 py-2 rounded-lg">
                        <span>Proposer une location&nbsp;&nbsp;</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
