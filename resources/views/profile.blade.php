...
<div class="w-3/4 m-auto">
    <div class="flex">
        <div class="flex flex-col items-center w-1/3">
            <a href="{{ route('ad.myads') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <div class="border-l-2 border-r-blue-900 flex flex-col items-center w-1/3">
            <a href="{{ route('conversations.index') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
                      d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"/>
            </svg></a>
            <p class="my-3">Messages</p>
            <p>0</p>

        </div>
        <div class="border-l-2 border-r-blue-900 flex flex-col items-center w-1/3">
            <a href="{{ route('favorites') }} "><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                 stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="bg-gray-300 w-[720px] m-auto my-5">
