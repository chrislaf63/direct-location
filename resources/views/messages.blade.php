                ...
                <form action="{{ route('messages.store') }}" method="POST">
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col">
                            ...
                            <textarea class="rounded-2xl resize-none mt-2" name="content" id="content" cols="42"
                                      rows="15"></textarea>
                        </div>
                        <button class="text-white font-medium py-2 bg-blue-900 rounded-xl hover:bg-blue-800"
                                type="submit">Envoyer
                        </button>
                    </div>
            </div>
